...
金融领域保留七个成熟场景。生物医药领域提供四个独立场景入口：小分子电子结构已接通 CASCAQit Digital VQE 与 QWC 有限 shots 测量，构象匹配已接通 QUBO、Hybrid D-A-D QAOA 和 Digital QAOA；金属活性中心与小肽能景当前仍为结构预览，不生成虚构的量子结果。
...
- 生物医药当前有 H2 电子结构和 1HSG 构象匹配两条真实本地模拟执行链；金属活性中心和小肽能景仍是明确标记的结构预览。
