"""Domain-neutral QUBO semantics owned by the biomedicine demo package."""
...
class OptimizationProblemDefinition:
    """A biomedicine QUBO plus domain variables, ledger, and geometry evidence."""
    ...
    def __post_init__(self) -> None:
        ...
        if not self.coefficient_contributions:
            raise ValueError(
                "biomedicine QUBO definitions require a coefficient ledger"
            )
