...
FIXTURES = (
    ...
    FixtureSpec(
        key="lih_sto3g_1200",
        directory="lih_sto3g_1200",
        dataset_id="electronic.lih.sto3g.1200.active-2e-3o",
        molecule="LiH",
        geometry_label="1.200 angstrom active-space scan point",
        geometry=(("Li", (0.0, 0.0, 0.0)), ("H", (0.0, 0.0, 1.2))),
        bonds=((0, 1, 1),),
        occupied_indices=(0,),
    ...
    FixtureSpec(
        key="lih_sto3g_1400",
        directory="lih_sto3g_1400",
        dataset_id="electronic.lih.sto3g.1400.active-2e-3o",
        molecule="LiH",
        geometry_label="1.400 angstrom active-space scan point",
        geometry=(("Li", (0.0, 0.0, 0.0)), ("H", (0.0, 0.0, 1.4))),
        bonds=((0, 1, 1),),
        occupied_indices=(0,),
        active_indices=(1, 2, 3),
        active_electrons=2,
    ...
    FixtureSpec(
        key="lih_sto3g_1800",
        directory="lih_sto3g_1800",
        dataset_id="electronic.lih.sto3g.1800.active-2e-3o",
        molecule="LiH",
        geometry_label="1.800 angstrom active-space scan point",
        geometry=(("Li", (0.0, 0.0, 0.0)), ("H", (0.0, 0.0, 1.8))),
        bonds=((0, 1, 1),),
        occupied_indices=(0,),
        active_indices=(1, 2, 3),
        active_electrons=2,
    ...
    FixtureSpec(
        key="lih_sto3g_2200",
        directory="lih_sto3g_2200",
        dataset_id="electronic.lih.sto3g.2200.active-2e-3o",
        molecule="LiH",
        geometry_label="2.200 angstrom active-space scan point",
        geometry=(("Li", (0.0, 0.0, 0.0)), ("H", (0.0, 0.0, 2.2))),
        bonds=((0, 1, 1),),
        occupied_indices=(0,),
        active_indices=(1, 2, 3),
        active_electrons=2,
