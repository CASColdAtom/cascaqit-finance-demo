...
const zh = {
  productTitle: "中科酷原行业量子实验台",
  productSubtitle: "CASCAQit INDUSTRY QUANTUM WORKBENCH",
  industryDomain: "行业领域",
  financeDomain: "金融",
  ...
  syntheticData: "合成数据",
  auditReady: "执行可审计",
  capabilityStatus: "量子能力状态",
  neutralAtomNative: "NEUTRAL ATOM NATIVE",
  hybridQuantumWorkflow: "HYBRID QUANTUM WORKFLOW",
  ...
  gridSearch: "二维网格",
  seededSearch: "固定种子采样",
  continuousSearch: "连续优化（COBYLA）",
  evaluationBudget: "评估预算",
  optimizerStarts: "优化起点数",
  independentRuns: "独立运行次数",
  researchConfiguration: "高级配置",
  estimatedLocalRuntime: "预计执行耗时",
  repeatedStatistics: "重复运行统计",
  quantumFeasibleRate: "量子候选可行率",
  objectiveConfidenceInterval: "目标值 95% 置信区间",
  totalEvaluations: "总目标评估",
  representativeRun: "代表运行",
  runIndex: "运行",
  candidateFeasible: "候选可行",
  running: "执行中",
  analyzing: "分析中",
  runExperiment: "运行",
  previewOnly: "结构预览",
  ...
  resultsView: "结果视图",
  businessResult: "领域结果",
  scenarioSituation: "场景结构",
  problemMapping: "Problem / Hamiltonian 映射",
  quantumExperiment: "量子实验",
  comparisonAnalysis: "对照分析",
  auditEvidence: "审计证据",
  lastExecution: "最近执行",
  analyzingStatus: "分析中",
  ...
  coefficientLedger: "业务规则与系数溯源",
  ledgerAnalysisNote: "逐项核对业务贡献与 Canonical QUBO；执行后补充 Analog / Digital 实际分配。",
  ledgerExecutedNote: "业务贡献、Canonical QUBO 和当前 Hamiltonian 实现来自同一次编译。",
  contributions: "条贡献",
  businessRule: "业务规则",
  contributionId: "贡献 ID",
  sourceCoefficient: "原始贡献系数",
  canonicalTerm: "Canonical 项",
  canonicalCoefficient: "聚合系数",
  hamiltonianImplementation: "Hamiltonian 实现",
  conservation: "守恒",
  conserved: "已守恒",
  notConserved: "未守恒",
  constantOffset: "常数偏移",
  noPhysicalTerm: "常数项不生成物理算符",
  operator: "算符",
  variable: "变量",
  logical: "逻辑",
  implementation: "实现",
  ...
  pairs: "变量对",
  coreCoverage: "核心贡献",
  geometryEvidence: "几何证据",
  missingEvidence: "缺失",
  unexpectedEvidence: "异常",
...
const en: MessageDictionary = {
  productTitle: "CASColdAtom Industry Quantum Workbench",
  productSubtitle: "CASCAQit INDUSTRY QUANTUM WORKBENCH",
  ...
  capabilityStatus: "Quantum Capability Status",
  neutralAtomNative: "NEUTRAL ATOM NATIVE",
  hybridQuantumWorkflow: "HYBRID QUANTUM WORKFLOW",
  traceableExecution: "TRACEABLE EXECUTION",
  ...
  loadFailed: "Unable to Load Industry Scenarios",
  ...
  fixedLayers: "Fixed",
  adaptiveLayers: "Adaptive",
  ansatzLayers: "Ansatz Layers",
  ...
  presetSearch: "Preset",
  gridSearch: "2D Grid",
  seededSearch: "Seeded Sample",
  continuousSearch: "Continuous (COBYLA)",
  evaluationBudget: "Evaluation Budget",
  optimizerStarts: "Optimizer Starts",
  independentRuns: "Independent Runs",
  researchConfiguration: "Advanced Configuration",
  estimatedLocalRuntime: "Estimated runtime",
  repeatedStatistics: "Repeated-run Statistics",
  quantumFeasibleRate: "Quantum Candidate Feasible Rate",
  objectiveConfidenceInterval: "Objective 95% Confidence Interval",
  totalEvaluations: "Total Objective Evaluations",
  representativeRun: "Representative Run",
  runIndex: "Run",
  candidateFeasible: "Candidate Feasible",
  running: "Running",
  analyzing: "Analyzing",
  runExperiment: "RUN",
  previewOnly: "STRUCTURE PREVIEW",
  resetScenario: "Reset Current Scenario",
  buildingMapping: "Building Problem Mapping",
  resultsView: "Result Views",
  businessResult: "Domain Result",
  scenarioSituation: "Scenario Structure",
  problemMapping: "Problem / Hamiltonian Mapping",
  ...
  coefficientLedger: "Business Rules and Coefficient Provenance",
  ledgerAnalysisNote: "Each business contribution is checked against Canonical QUBO; run the experiment to add the actual Analog / Digital allocation.",
  ledgerExecutedNote: "Business contributions, Canonical QUBO, and the current Hamiltonian implementation come from the same compilation.",
  contributions: "contributions",
  businessRule: "Business Rule",
  contributionId: "Contribution ID",
  sourceCoefficient: "Source Coefficient",
  canonicalTerm: "Canonical Term",
  canonicalCoefficient: "Aggregated Coefficient",
  hamiltonianImplementation: "Hamiltonian Implementation",
  conservation: "Conservation",
  conserved: "Conserved",
  notConserved: "Not Conserved",
  constantOffset: "Constant Offset",
  noPhysicalTerm: "Constant offsets do not generate physical operators",
  operator: "Operator",
  variable: "Variables",
  logical: "Logical",
  ...
  logicalLayers: "Variational Logical Layers",
  verified: "Verified",
...
export function scenarioFrontierOutlook(
  caseId: string,
  language: Language,
): string | null {
  return scenarioFrontierOutlooks[language][caseId] ?? null;
}
...
> = {
  ...
  docking_match: {
    shortTitle: "Pose Matching",
    title: "Target-pocket and Ligand Candidate-pose Matching",
    description:
      "Map discrete candidate interactions to matching rewards, occupancy conflicts, and coverage constraints.",
    presets: {
  ...
  active_center: {
    ...
    controls: {
      ...
      local_field: "Local Field h",
    },
  },
  peptide_landscape: {
    shortTitle: "Peptide Landscape",
    title: "Discrete Peptide Conformations and Folding Landscape",
    description:
      "Explore coarse-grained contact energies and low-energy candidates in a finite 2D self-avoiding conformation library.",
    presets: {
  ...
  rna_structure: {
    ...
    presets: {
      ...
      limited_pseudoknot: "Limited Pseudoknot Preset",
    },
    controls: {
...
const contentEnglish: Record<string, string> = {
  "风险收益目标": "Risk-return Objective",
  "协方差风险": "Covariance Risk",
  "固定持仓数": "Fixed Holding Count",
  "行业集中度上限": "Sector Concentration Cap",
  "结算价值": "Settlement Value",
  "交易两两冲突": "Pairwise Trade Conflict",
  "交易前置依赖": "Trade Prerequisite",
  "币种流动性上限": "Currency Liquidity Limit",
  "结算批次上限": "Settlement Batch Cap",
  "调查任务价值": "Investigation-task Value",
  "固定调查席位": "Fixed Investigator Slots",
  "共享实体并行冲突": "Shared-entity Concurrency Conflict",
  "价值成本目标": "Value-cost Objective",
  "固定选择数量": "Fixed Selection Count",
  "分组精确数量": "Exact Group Count",
  "分组集中度上限": "Group Concentration Cap",
  "资源单位上限": "Maximum Resource Units",
  "资源单位下限": "Minimum Resource Units",
  "候选项两两冲突": "Pairwise Candidate Conflict",
  "候选项前置依赖": "Candidate Prerequisite",
  "待执行模式分配": "Pending Mode Allocation",
  "数字量子门": "Digital Quantum Gate",
  "原子相互作用": "Atomic Interaction",
  "局域失谐": "Local Detuning",
  "全局失谐": "Global Detuning",
  "模拟与数字共同承担": "Shared Analog / Digital Implementation",
